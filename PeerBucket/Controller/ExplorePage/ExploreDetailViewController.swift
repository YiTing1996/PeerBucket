...
final class ExploreDetailViewController: UIViewController {
    ...
    private lazy var ratingView: UIView = create {
    ...
    private lazy var webButton: UIButton = create {
    ...
    private lazy var ratingImageView: UIImageView = create {
        $0.image = UIImage(named: "icon_rating3")
    }
    
    private lazy var ratingLabel: UILabel = create {
        $0.font = UIFont.bold(size: 20)
        $0.textColor = UIColor.lightGray
    }
    
    private lazy var collectButton: UIButton = create {
    ...
    @objc
    private func tappedWebBtn() {
        guard let webVC = initFromStoryboard(with: .web) as? WebViewController, let content = content else { return }
...
extension ExploreDetailViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: ExploreDetailTableViewCell.cellIdentifier, for: indexPath)
